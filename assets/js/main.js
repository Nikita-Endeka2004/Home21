    ...
    let daysBelowZero2 = 0, daysBelowZero3 = 0;
    ...
    for(let i = 0; i < winterDays.length; i++){
        ...
        if(winterDays[i] < 0){
            ...
            console.log(daysBelowZero);

            if(winterDays[i+1] >= 0){

                daysBelowZero3 = daysBelowZero;
                daysBelowZero = 0;

                if(daysBelowZero3 > daysBelowZero2){

                    daysBelowZero2 = daysBelowZero3;
    ...
    console.log(`Период заморозков - ${daysBelowZero2} дней`);

    console.log(`Количество замерзаний - ${col} дней`);